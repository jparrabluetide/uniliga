      ...
      <div class="upcomingGames__grid">
        ...
        <?php if ($data->have_posts()): ?>
          <?php while ($data->have_posts()):
            ...
            ?>
            <div class="upcomingGames__card">
              <p class="upcomingGames__nextMatch">Próximo partido</p>
              <div class="upcomingGames__containerDate upcomingGames__containerDate--1">
                <div class="upcomingGames__dateIcons">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_15_522" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24"
                      height="24">
                  ...
                  <p class=""><?php echo $gameDate; ?></p>
                </div>
                <div class="upcomingGames__dateIcons">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_15_523" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24"
                      height="24">
                      <rect width="24" height="24" fill="#D9D9D9" />
                    </mask>
                  ...
                  <p class=""><?php echo $gameHour; ?></p>
                </div>
              </div>
              <hr />
              <div class="upcomingGames__containerTeams">
                <div class="">
                  <div class="upcomingGames__teamLogo">
                    <?php echo get_the_post_thumbnail($teams[0], 'sportspress-fit-icon', array('itemprop' => 'logo')); ?>
                  </div>
                  <p class="upcomingGames__teamName"><?php echo get_the_title($teams[0]); ?></p>
                </div>
                <p class="upcomingGames__vs">VS</p>
                <div class="">
                  <div class="upcomingGames__teamLogo">
                    <?php echo get_the_post_thumbnail($teams[1], 'sportspress-fit-icon', array('itemprop' => 'logo')); ?>
                  </div>
                  <p class="upcomingGames__teamName"><?php echo get_the_title($teams[1]); ?></p>
                </div>
              </div>
              <hr />
              <div class="upcomingGames__containerDate upcomingGames__containerDate--2">
                <div class="upcomingGames__dateIcons">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_15_522" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24"
                      height="24">
              ...
              <hr class="match-1" />
              <div class="upcomingGames__containerLeague">
                <p class="">
  ...
  public function form($instance)
  {
    ...
    <p>
      ...
      <input class="widefat" id="<?php echo $this->get_field_id('numberOfPosts'); ?>"
        name="<?php echo $this->get_field_name('numberOfPosts'); ?>" type="text" value="<?php echo $numberOfPosts; ?>">
    </p>
    <?php
    restore_current_blog();
  }
