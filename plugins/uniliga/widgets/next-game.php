...
?>
    ...
    if ($data->have_posts()):
      ...
      wp_reset_postdata();
    ?>
      <div class="grid grid-cols-2 grid-rows-2 gap-4 font-family-inter">
        <div class="bg-teal-800 col-span-2 lg:col-span-1 row-span-2">
          <div class="flex flex-col justify-between h-full">
            <div class="">
              <h4 class="!text-white text-center !mb-0 pb-2 pt-4 uppercase !text-base md:!text-2xl font-family-inter">Próximo partido</h4>
              <div class="px-4 w-full">
                <div class="w-full bg-mainColor h-[1px] mb-5"></div>
              </div>
            </div>
        ...
        <div class="col-span-2 lg:col-span-1 row-span-1">
          <div class="border border-teal-800">
            <div class="flex items-center justify-center gap-6 pt-2">
              <div class="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="currentColor" class="h-7 w-7 text-mainColor text-sport">
                  <mask id="mask0_17_2351" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="40" height="41">
                    <rect y="0.687012" width="40" height="40" fill="currentColor" />
                  </mask>
                  <g mask="url(#mask0_17_2351)">
                ...
                <p class="text-teal-800 !mb-0 text-base"><?php echo $gamesData[1]['gameDate']; ?></p>
              </div>
              <div class="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="currentColor" class="h-7 w-7 text-mainColor text-sport">
                  <mask id="mask0_17_2354" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="40" height="41">
                ...
                <p class="text-teal-800 !mb-0 text-base"><?php echo $gamesData[1]['gameHour']; ?></p>
              </div>
            </div>
            <div class="px-4 w-full mt-2">
              <div class="w-full bg-mainColor h-[1px] mb-3"></div>
            </div>
            <div class="my-2 flex gap-2 justify-between items-center px-4">
              <div class="">
                ...
                <p class="text-teal-800 !mb-0 text-xs md:text-base text-center uppercase">
                  <?php echo get_the_title($gamesData[1]['teams'][0]); ?>
                </p>
              </div>
              <p class="text-teal-800 !mb-0 text-base">VS</p>
              <div class="">
                <div class="w-20 h-20 md:w-20 md:h-w-20 mx-auto bg-gray-300 rounded-full mb-2 flex items-center justify-center [&>img]:aspect-square [&>img]:w-16 [&>img]:object-contain">
            ...
            <div class="bg-gradient-to-b-mainColor text-white py-2 px-4">
              <p class="text-white !mb-0 text-sm md:text-base text-center uppercase">
          ...
          <div class="border border-teal-800">
            <div class="flex items-center justify-center gap-6 pt-2">
              <div class="flex items-center gap-2">
                ...
                <p class="text-teal-800 !mb-0 text-base"><?php echo $gamesData[2]['gameDate']; ?></p>
              </div>
              <div class="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="currentColor" class="h-7 w-7 text-mainColor text-sport">
                  <mask id="mask0_17_2354" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="40" height="41">
                ...
                <p class="text-teal-800 !mb-0 text-base"><?php echo $gamesData[2]['gameHour']; ?></p>
              </div>
            </div>
            <div class="px-4 w-full mt-2">
              <div class="w-full bg-mainColor h-[1px] mb-3"></div>
