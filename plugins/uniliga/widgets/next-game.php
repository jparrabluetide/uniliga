          ...
          <div class="flex flex-col justify-between h-full">
            ...
            <div class="flex items-center justify-between gap-4 px-4 pb-5">
              <div class="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="currentColor" class="text-mainColor">
        ...
        <div class="col-span-2 lg:col-span-1 row-span-1">
          <div class="border border-[#003B4D]">
            <div class="flex items-center justify-center gap-6 pt-2">
              <div class="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="41" viewBox="0 0 40 41" fill="currentColor" class="h-7 w-7 text-mainColor">
                  <mask id="mask0_17_2351" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="40" height="41">
                    <rect y="0.687012" width="40" height="40" fill="currentColor" />
                  </mask>
                  <g mask="url(#mask0_17_2351)">
