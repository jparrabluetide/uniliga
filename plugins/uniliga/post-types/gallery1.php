...
$labels = array(
  ...
  'all_items' => __('All galleries', 'bluetide'),
  ...
  'view_items' => __('View galleries', 'bluetide'),
  'search_items' => __('Search galleries', 'bluetide'),
  'not_found' => __('No galleries found', 'bluetide'),
  'not_found_in_trash' => __('No galleries found in the trash', 'bluetide'),
  ...
  'insert_into_item' => __('Insert to galleries', 'bluetide'),
  'uploaded_to_this_item' => __('Upload to gallery', 'bluetide'),
  'items_list' => __('List of gallerys', 'bluetide'),
  'items_list_navigation' => __('Navigate to list of galleries', 'bluetide'),
  'filter_items_list' => __('Filter list of galleries', 'bluetide'),
);
$args = array(
