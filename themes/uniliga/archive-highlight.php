...
<div class="container mx-auto px-4 pt-10 md:pt-20 pb-10 max-w-7xl">
  <h1 class="text-2xl md:text-4xl font-family-inter text-teal-800 uppercase font-medium mb-8"><?php echo __('Highlights', 'bluetide') ?></h1>
    ...
    <div class="grid grid-cols-3 gap-4">
      ...
      ?>
        <div class="col-span-3 lg:col-span-1">
          <div class="p-7 bg-gray-300 w-full h-[350px] md:h-[500px] bg-cover bg-no-repeat rounded-2xl" style="background-image: url('<?php echo get_the_post_thumbnail_url($dataId, 'highlight-card'); ?>')">
            <div class="flex flex-col justify-between h-full">
              ...
              <div class="">
                ...
                <h4 class="text-lg md:text-xl lg:text-2xl font-family-inter text-teal-800 uppercase max-w-[320px] mb-5">
                  <?php the_title(); ?>
                </h4>
                <button data-title="<?php the_title(); ?>" data-modal="modal-highlights" data-videoid="<?php echo $videoId; ?>" class="btn-modal cursor-pointer font-family-inter uppercase text-teal-800 text-sm md:text-base flex items-center gap-2 border-b border-teal-800 w-max px-3 pb-2">
                  Ver highlights
