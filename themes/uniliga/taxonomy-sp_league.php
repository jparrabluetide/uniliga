...
<div class="container mx-auto px-4 max-w-7xl">
  <div class="w-full py-12">
    <h3 class="text-2xl md:text-4xl font-family-inter uppercase text-teal-800 mb-7 font-bold">
    ...
    <div class="grid grid-cols-12 gap-4">
      ...
      <div class="col-span-12 md:col-span-6 lg:col-span-4 tablePosition bg-[#D9D9D9] p-5">
        ...
        <div class="bg-white px-4 py-4 -mt-5">
          <a href="<?php echo home_url('/posiciones', 'relative'); ?>" class=" text-white bg-sport font-family-inter font-normal uppercase text-base text-center py-4 px-2 block">Ver tabla completa</a>
        </div>
      </div>
    </div>
  </div>
