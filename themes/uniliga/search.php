<?php get_header(); ?>
<header class="page-header py-16 bg-cyan-500 mb-10">
  <div class="container mx-auto px-4 max-w-7xl">
    <h1 class="page-title text-white font-family-inter text-2xl md:text-4xl uppercase">
      <?php
...
<div class="searchResults container mx-auto px-4 max-w-7xl">
  <?php if (have_posts()) : ?>
