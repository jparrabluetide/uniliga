<div class="swiper swiperCarousel1">
  <div class="swiper-wrapper">
    <div class="swiper-slide">
      <div class="w-full h-carousel1 bg-gray-400">
            ...
            <div class="">
              ...
              <div class="flex items-center gap-3 md:gap-6 mb-5">
                <div class="flex items-center gap-2">
                  ...
                  <p class="font-family-roboto text-sm md:text-base text-white">20 Mayo, 2025</p>
                </div>
                <div class="flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
                    <mask id="a" width="24" height="24" x="0" y="0" maskUnits="userSpaceOnUse" style="mask-type:alpha">
                  ...
                  <p class="font-family-roboto text-sm md:text-base text-white">Yappy Park</p>
                </div>
              </div>
              <div class="flex flex-col md:flex-row items-center gap-2 md:gap-6">
                <a href="#" class="px-4 py-2 text-tarawera-950 bg-scooter-500 font-family-oswald uppercase text-base flex items-center gap-2">
                  ver highlights
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
                    <mask id="a" width="24" height="24" x="0" y="0" maskUnits="userSpaceOnUse" style="mask-type:alpha">
                      <path fill="#D9D9D9" d="M0 0h24v24H0z" />
                ...
                <a href="#" class="px-4 py-2 text-white bg-tarawera-950 font-family-oswald uppercase text-base flex items-center gap-2">
                  Más información
                </a>
              </div>
            </div>
