    ...
    <div class="col-span-3 md:col-span-1">
      <div class="w-full h-full bg-cover bg-no-repeat" style="background-image: url(https://picsum.photos/id/29/620/640)">
        <div class="w-full h-full flex flex-col justify-end px-4 md:px-7 pb-6 pt-14">
          ...
          <a href="https://picsum.photos/id/29/620/640" data-lightbox="gallery-1" data-title="Click the right half of the image to move forward." class="font-family-oswald uppercase text-tarawera-950 text-sm md:text-base flex items-center gap-2 border-b border-tarawera-950 w-max px-3 pb-2">
            Ver highlights
