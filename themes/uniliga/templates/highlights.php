        ...
        <div class="flex flex-col justify-between h-full">
          <div class="bg-tarawera-950 w-14 h-14 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="none">
              <path fill="#fff" d="M3.333 30a3.21 3.21 0 0 1-2.354-.98A3.21 3.21 0 0 1 0 26.668V3.333C0 2.417.326 1.632.98.98A3.21 3.21 0 0 1 3.332 0h23.334a3.21 3.21 0 0 1 2.354.98A3.21 3.21 0 0 1 30 3.332v23.334a3.21 3.21 0 0 1-.98 2.354 3.21 3.21 0 0 1-2.353.979H3.333ZM5 15.958l6.667-6.666 6.666 6.666L25 9.292l1.667 1.666V3.333H3.333v10.959L5 15.958ZM3.333 26.667h23.334v-11L25 14l-6.667 6.667L11.667 14 5 20.667 3.333 19v7.667Zm0 0v-11V19 3.333v23.334Z" />
            </svg>
          </div>
          <div class="">
